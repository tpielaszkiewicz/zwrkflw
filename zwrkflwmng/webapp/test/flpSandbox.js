		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#compgbtpzwrkflwmng-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compgbtpzwrkflwmng-display": {
								"semanticObject": "compgbtpzwrkflwmng",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pg.btp.zwrkflwmng",
									"url": sap.ui.require.toUrl("com/pg/btp/zwrkflwmng")
								}
							}
						}
					}
